...
class _MyHomePageState extends State<MyHomePage> with FBAuth {
  ...
  void _checkUserStatus() async {
    ...
    if (alertString.trim() != '') {
      ...
      if (_userId == null) {
        _userId = await addUserUsingEmail(context, _emailTextController.text) ??
  ...
  void _moveToChatList(List<String> userData) {
    ...
    if (userData != null) {
      ...
      showAlertDialog(context, 'Save user data error');
    }
  }

// verifyPhone() async {
//   await FirebaseAuth.instance.verifyPhoneNumber(
//     phoneNumber: firstNameController.text,
//     verificationCompleted: (PhoneAuthCredential credential)  {
//       String ss = credential.smsCode;
//       print(ss);
//       firebaseUid(credential,context);
//     },
...
// void firebaseUid(PhoneAuthCredential credential,BuildContext context) async {
//   try {
//     UserCredential res = await FirebaseAuth.instance
//         .signInWithCredential(credential).then((value) {
//       /*Get.offNamed(NavGraph.routeSignUpPage);*/
//     });
//
...
//           SnackBar(content: Text('INVALID TEXT')));
//     } else {
//       Scaffold.of(context).showSnackBar(
